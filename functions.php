...
function wpbb_hotel_after_hero_finder( $content, $profile ) {
    if ( ( $profile['id'] ?? '' ) !== 'hotel' ) return $content;
    return $content . '<!-- wp:wpbb/bootstrap-div {"containerClass":"","utilityClasses":"wp-theme-section-shell wpbb-hotel-finder-section","className":"wpbb-v62-section"} --><!-- wp:wpbb/row {"containerClass":"container"} --><!-- wp:wpbb/column {"xs":12} --><!-- wp:wpbb/sector-finder {"context":"hotel","limit":8} /--><!-- /wp:wpbb/column --><!-- /wp:wpbb/row --><!-- /wp:wpbb/bootstrap-div -->';
}
...
// v3.8.11.37 canonical 1320px content-edge alignment hotfix.
require_once get_stylesheet_directory() . '/inc/v137-alignment.php';

// v3.8.11.38 shared section grid, hotel-green pagination, row-30 demo cards and centered fun facts.
require_once get_stylesheet_directory() . '/inc/v138-grid-polish.php';

// v3.8.11.39 unified Hotel homepage/inner-page grid and WooCommerce finalisation.
